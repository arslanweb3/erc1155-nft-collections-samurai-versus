...
contract GenesisFireSamurai is ERC1155, ERC2981, IGenesisWaterSamurai, Ownable, ReentrancyGuard, Pausable {
    ...
    // @notice 10 free mint tokens are reserved in Genesis Fire Samurai Collection for particular users and each time someone claims free tokens -> 'freeMintAmount' count will decrease
    ...
    // @notice Owner() calls 'reserveFreeMintTokens' function to set Genesis Water Samurai contract collection's address
